// Source: https://github.com/javiertoledo/bootstrap-rating-input
// modified to use FontAwesome instead of glyphicons
// modified to not run on pageload so that we can run it manually
//   when turbolinks loads a page
(function ($) {
  'use strict';
